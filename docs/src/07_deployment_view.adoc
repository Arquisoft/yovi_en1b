...
| User Interface | Webapp Container | React + TypeScript + Vite | 80 | Users (3000)
| User Management & Persistence | Users Container | Node.js + Express | 3000 | MongoDB (27017), Gamey (4000)
